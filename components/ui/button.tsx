...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    return (
      <button
        className={twMerge(
          `inline-flex items-center jusify-center gap-2 px-8 py-4 rounded-full font-medium text-base outline-default focus-visible:outline-${colors} transition-[transform,background-color,color] active:scale-95 disabled:pointer-events-none disabled:opacity-50`,
          variants[variant],
          className,
        )}
        ref={ref}
